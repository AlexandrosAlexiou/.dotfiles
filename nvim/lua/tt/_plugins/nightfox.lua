    ...
    require("nightfox").setup {
        ...
        groups = {
            ...
            carbonfox = {
                ...
                FinderCode = { fg = colors.blue.dim, style = "italic" },
                FinderCount = { link = "FinderIcon" },
                FinderIcon = { link = "TitleString" },
                FinderSelection = { link = "TelescopeSelection" },
                FinderSpinner = { link = "TitleIcon" },
                FinderSpinnerTitle = { link = "TitleIcon" },
